...
class environment:
    def __init__(self, display_game=True):
        ...
        # adjust score as you see fit
        self.step_punishment = -0.0025
        self.border_punishment = -2.5
        self.apple_reward = 7.5
        self.self_eat_punishment = -15
    ...
    def step(self, action="None"):
        ...
        for block in self.snake_body[1:]:
            ...
            if self.snake_position[0] == block[0] and self.snake_position[1] == block[1]:
                ...
                reward = self.self_eat_punishment
    ...
    def play_back_game(self, epoch):
        ...
        filename = f"C:/Users/offic/Desktop/A lifetime of work/RLSnake/q_learning_snake_dqn/training_data/{epoch}.pickle"
