...
class DQNAgent:
    def __init__(self, input_size=12, output_size=4, lr=0.0025, gamma=0.995, max_epochs=10000, epsilon_start=1.0, epsilon_min=0.001, epsilon_decay_rate=0.9975, display_game=True):
